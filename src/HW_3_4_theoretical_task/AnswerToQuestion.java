package HW_3_4_theoretical_task;
...
//    Ответ:
//    Меньше всего времени для выполнения данного метода при большом наборе данных потребуется коллекции - HashSet.
//    В данной ситуации HashSet сумеет найти элементы быстро, за фиксированное (константное) время.
